			...
			<div id="content">
				<!-- Topbar -->
                            ...
                            <?php if ($_SESSION['rol'] == 1) { ?>
                                	<nav class="navbar navbar-expand navbar-light text-white topbar mb-4 static-top shadow" style="background-color: #8A0000;">
                            <?php }else{ ?> 
                               	<nav class="navbar navbar-expand navbar-light text-white topbar mb-4 static-top shadow" style="background-color: #001367;"> 
					...
					<div class="input-group">
                                              <a href="../../index.php">Ir página principal</a>
   <hr>
   <p></p>
                                            <strong> <h5>Bienvenido: <?php echo $_SESSION['rol_name'];?></h5></strong>
