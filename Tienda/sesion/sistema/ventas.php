...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">MIS COMPRAS</h1>
             ...
             <a href="nueva_venta.php" class="btn btn-primary">VER MI CARRITO</a>
                 <?php } ?>
	</div>
				...
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						<?php
                                      ...
                                      $id=$_SESSION['idUser'];   
						require "../conexion.php";
						$query = mysqli_query($conexion, "SELECT nofactura, fecha,codcliente, totalfactura, estado FROM factura where usuario=$id ORDER BY nofactura DESC");
						mysqli_close($conexion);
						$cli = mysqli_num_rows($query);
